...
CFLAGS += -std=c++17 -fexperimental-library #-sWASM=1 -sUSE_SDL=2 -sMAX_WEBGL_VERSION=2 -sLEGACY_GL_EMULATION -sEXPORTED_RUNTIME_METHODS=ccall,cwrap
ifeq ($(CONFIG),DEBUG)
	CFLAGS += -O0 --profiling
else
	CFLAGS += -Os
...
#------------------------------------------------------------------------------------------------
INCLUDE_PATHS = -I$(SRC_PATH) -I../Vendors/SDL/include -I../Vendors/spdlog/include 
...
#------------------------------------------------------------------------------------------------
OBJS = 	$(INTERM_PATH)/Application.o \
		$(INTERM_PATH)/Log.o \
		$(INTERM_PATH)/WindowsWindow.o
...
ifeq ($(PLATFORM),PLATFORM_WEB)
	$(output_guard)
	$(AR) rcs $(RELEASE_PATH)/$(LIB_NAME).a $(OBJS)
	@echo "Library generated ($(LIB_NAME).a)!"
endif

# Compile core module
$(INTERM_PATH)/Application.o : $(SRC_PATH)/Lucky/Application/Application.cpp
	$(interm_guard)
	$(CC) -c $< $(CFLAGS) $(INCLUDE_PATHS) -o $@

$(INTERM_PATH)/Log.o : $(SRC_PATH)/Lucky/Core/Log.cpp
	$(interm_guard)
	$(CC) -c $< $(CFLAGS) $(INCLUDE_PATHS) -o $@

$(INTERM_PATH)/WindowsWindow.o : $(SRC_PATH)/Lucky/Platforms/windows/WindowsWindow.cpp
	$(interm_guard)
	$(CC) -c $< $(CFLAGS) $(INCLUDE_PATHS) -o $@
